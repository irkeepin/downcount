...
class TestModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test_model" do
    assert_difference('TestModel.count') do
      post test_models_url, params: { test_model: { name: @test_model.name, target_date: @test_model.target_date } }
    end
  ...
  test "should update test_model" do
    patch test_model_url(@test_model), params: { test_model: { name: @test_model.name, target_date: @test_model.target_date } }
